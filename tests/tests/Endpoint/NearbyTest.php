...
class NearbyTest extends BaseTestCase
{
    public function testNearbyReturnsSuccessResult(): void
    {
        $apiJson = \json_encode([
            'success' => true,
            'code'    => 0,
        ...
        $apiParams = Params::create()
                           ...
                           ->withLocation(50.0755, 14.4378);

        $result = $apiClient->nearby($apiParams);

        $this->assertTrue($result->success());
    }

    public function testNearbyReturnsErrorResultOnApiFailure(): void
    {
